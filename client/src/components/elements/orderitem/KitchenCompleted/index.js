...
class OrderItem extends React.Component {
    ...
    render() {
        var timeFrom = moment(this.props.orderItem.orderTime, "X").from(moment(this.props.orderItem.completeTime, "X"));
                ...
                <div className="orderitem h-100 w-100 bg-secondary color-white d-flex flex-column" style={{ border: "1px solid white" }}>
                    <div className="bg-dark d-flex flex-column px-3 py-2">
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <p className="m-0 color-white-06">{moment(this.props.orderItem.completeTime, "X").format("hh:mm")}&nbsp;<small>{moment(this.props.orderItem.completeTime, "X").format("A")}</small></p>
                        </div>
                    </div>
