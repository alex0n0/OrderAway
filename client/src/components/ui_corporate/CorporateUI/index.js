        ...
        return (
            <>
                <Route exact path="/corporate">
                    <CorporateLayout sidebarmenu={this.state.sidebarmenu} sidebarMenuActiveIndex={0} handleSidebarOptionClick={this.handleSidebarOptionClick} sidebarlinks={this.state.sidebarlinks} history={this.props.history} restaurant={this.state.restaurant}>
                ...
                <Route exact path="/corporate/menu">
                    <CorporateLayout sidebarmenu={this.state.sidebarmenu} sidebarMenuActiveIndex={1} handleSidebarOptionClick={this.handleSidebarOptionClick} sidebarlinks={this.state.sidebarlinks} history={this.props.history} restaurant={this.state.restaurant}>
